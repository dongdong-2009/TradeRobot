...
INSERT INTO `Account` VALUES (1,'HrAccountEntity','10861479@qq.com','02989067-d194-4c75-9dcf-94632e9c9edb','78667F1CB906FAC4E895DFFD67400D96',0,0,'',1),(2,'HrAccountEntity','10861479@qq.com','yh6te-1wzf1-87acn-urjjp-tavp8-5abki-di1ib','zKhx2-iQhH~-@tWA&-yjgk*-ywhX)-X9EYQ-,eh3K',0,0,'',2);
...
INSERT INTO `HedgeRobot` VALUES (1,'Eth',86400,86400,86400,0.05,0.001,3600,172800);
...
INSERT INTO `HedgeRobotPlatformPair` VALUES (1,1,2,0.004,0.001,'BidBidPrice',0,1),(2,2,1,0.003,0.001,'AskAskPrice',0,1);
...
INSERT INTO `PlatformCoinRule` VALUES (1,1,'Eth',0.01,0.0005,'FloatingRate',0,0.1),(2,2,'Eth',0.01,0.0005,'FixedFee',0.01,0.35);
...
INSERT INTO `TableId` VALUES ('Account',3),('HedgeRobotAccountGroup',2),('HedgeRobotPlatformPair',3),('Log',1),('Market',1),('Order',1),('Platform',3),('PlatformApiRule',13),('PlatformCoinRule',3),('Robot',2);
...
-- Dump completed on 2017-07-17  9:43:57
