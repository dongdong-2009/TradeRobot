...
INSERT INTO `Account` VALUES (1,'HrAccountEntity','10861479@qq.com','02989067-d194-4c75-9dcf-94632e9c9edb','78667F1CB906FAC4E895DFFD67400D96',77.7006,0.102954,'',1),(2,'HrAccountEntity','10861479@qq.com','yh6te-1wzf1-87acn-urjjp-tavp8-5abki-di1ib','zKhx2-iQhH~-@tWA&-yjgk*-ywhX)-X9EYQ-,eh3K',788.54,0.008,'',2);
...
INSERT INTO `HedgeRobot` VALUES (1,'Btc',86400,86400,86400,0.01,0.001,7200,172800);
...
INSERT INTO `HedgeRobotOrder` VALUES (1,NULL,NULL),(2,1499763896,NULL);
...
CREATE TABLE `Log` (
  `Id` int(10) unsigned NOT NULL,
  `Severity` enum('Success','Fail') NOT NULL,
...
INSERT INTO `Order` VALUES (1,'HrOrderEntity','Sell',8925236606,16439.9,16439.9,0.01,0.01,1499756695,1499756696,NULL,1),(2,'HrOrderEntity','Buy',370946179,16325.1,NULL,0.01,0,1499756696,NULL,NULL,2);
...
INSERT INTO `PlatformCoinRule` VALUES (1,1,'Btc',0.01,0.002,'FloatingRate',0,0.1),(2,2,'Btc',0.01,0.002,'FixedFee',0.001,0.1);
...
INSERT INTO `TableId` VALUES ('Account',3),('HedgeRobotAccountGroup',2),('HedgeRobotPlatformPair',3),('Log',1),('Market',1),('Order',3),('Platform',3),('PlatformApiRule',13),('PlatformCoinRule',3),('Robot',2);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `HedgeRobotView` AS select `r`.`Id` AS `RobotId`,'HedgeRobot' AS `RobotName`,`hr`.`CoinType` AS `CoinType`,`hrag`.`Id` AS `HrAccountGroupId` from ((`Robot` `r` join `HedgeRobot` `hr`) join `HedgeRobotAccountGroup` `hrag` on(((`r`.`Id` = `hr`.`Id`) and (`hr`.`Id` = `hrag`.`HedgeRobotId`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `PlatformCoinRuleView` AS select `p`.`Id` AS `id`,`p`.`Name` AS `Name`,`p`.`MinMarketQueryInterval` AS `MinMarketQueryInterval`,`p`.`MinOrderQueryInterval` AS `MinOrderQueryInterval`,`p`.`MinTradeInterval` AS `MinTradeInterval`,`p`.`CashWithdrawalFeeRate` AS `CashWithdrawalFeeRate`,`r`.`CoinType` AS `CoinType`,`r`.`MinTradingUnit` AS `MinTradingUnit`,`r`.`TransactionFeeRate` AS `TransactionFeeRate`,`r`.`CoinWithdrawalChargeType` AS `CoinWithdrawalChargeType`,`r`.`CoinWithdrawalPara` AS `CoinWithdrawalPara` from (`Platform` `p` join `PlatformCoinRule` `r` on((`p`.`Id` = `r`.`PlatformId`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2017-07-11 15:18:06
